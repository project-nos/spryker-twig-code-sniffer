 ...
 */
class DelimiterSpacingRuleProviderPlugin extends AbstractPlugin implements RuleProviderPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->createDelimiterSpacingRule();
    }
}
