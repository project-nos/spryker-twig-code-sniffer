 ...
 */
class TrailingCommaSingleLineRuleProviderPlugin extends AbstractPlugin implements RuleProviderPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->createTrailingCommaSingleLineRule();
    }
}
