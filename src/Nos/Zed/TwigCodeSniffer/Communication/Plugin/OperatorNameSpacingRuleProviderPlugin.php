 ...
 */
class OperatorNameSpacingRuleProviderPlugin extends AbstractPlugin implements RuleProviderPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->createOperatorNameSpacingRule();
    }
}
