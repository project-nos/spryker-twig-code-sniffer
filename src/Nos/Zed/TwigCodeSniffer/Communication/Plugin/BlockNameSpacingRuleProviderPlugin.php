 ...
 */
class BlockNameSpacingRuleProviderPlugin extends AbstractPlugin implements RuleProviderPluginInterface
{
    /**
    ...
    {
        return $this->getFactory()->createBlockNameSpacingRule();
    }
}
